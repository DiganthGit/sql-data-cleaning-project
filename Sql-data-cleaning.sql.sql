...
-- delete douplicate values 
-- Standardizing Data
-- Remove Null/Blank Values
-- Remove Unnecessary Columns/Rows

select *,
row_number() over(partition by company,industry,total_laid_off,`date`,country) as row_num
from layoffs;
...
select* from laid_cte where row_num>1;
...
rename column   rpw_num to row_num;
